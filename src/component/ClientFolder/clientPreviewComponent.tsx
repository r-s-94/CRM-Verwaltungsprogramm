    ...
    <div className="clients-preview">
          ...
          <div className="clients-preview__question-div">
            ...
            <div className="clients-preview__dialog-button-div center-content">
              ...
              <button
                ...
                className="clients-preview__delete-client-button button"
              >
                {" "}
                löschen
                <svg
      ...
      <div className="clients-preview__table-div center-content-column">
        ...
        <div className="clients-preview__headline-div center-content">
          <h2 className="clients-preview__headline clients-preview__first-name">
            Vorname
          </h2>
          <h2 className="clients-preview__headline clients-preview__last-name">
            Nachname
          </h2>
          ...
          {clientsStorageArray.map((client) => {
            return (
              <div className="clients-preview__client-info-div">
                <div className="clients-preview__client-info clients-preview__first-name-info">
                  {client.firstName}
                </div>
                <div className="clients-preview__client-info clients-preview__last-name-info">
                  {client.lastName}
                </div>
                ...
                <div className="clients-preview__client-info clients-preview__options-div">
                  <div className="clients-preview__button-div center-content">
                    <button
                      onClick={() => {
