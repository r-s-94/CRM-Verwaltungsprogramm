...
export default function OrdersPreviewComponent({
  ...
  function opendeleteOrderPopUp(id: number) {
    setOrderValueAdministration({
      ...orderValueAdministration,
      selectedOrderId: id,
    });
      ...
      {deleteSingleOrderPopUp && (
        <PopUpComponent>
          <div className="orders-preview__delete-single-order-form">
            ...
            <p className="orders-preview__text">
              Soll der Einzelauftrag wirklich entfernt werden?
            </p>
          ...
          <div className="orders-preview__single-order-div ">
            ...
            <div className="orders-preview__single-table-div center-content">
              ...
              <div className="orders-preview__single-info-div">
                ...
                <div className="orders-preview__single-order-info orders-preview__single-order-options center-content">
                  <div className="orders-preview__single-order-buttons center-content">
                    <div className="order-preview__single-action-order-tool-tip-div">
                      ...
                      <button
                        ...
                        onMouseLeave={hiddenToolTip}
                        className="orders-preview__single-order-edit-button center-content hover"
                      >
                        {" "}
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="order-preview__single-action-order-tool-tip-div">
                      ...
                      <button
                        ...
                        onMouseLeave={hiddenToolTip}
                        className="orders-preview__single-order-delete-button center-content delete-button hover"
                      >
                        {" "}
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="orders-preview__table-div">
        ...
        >
          ...
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            className="orders-preview__new-order-document-icon"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
          ...
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            className="orders-preview__new-order-plus-icon"
          >
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
        ...
        <div className="orders-preview__headline-div">
          <h2 className="orders-preview__headline orders-preview__id">
            Auftrags-Id
          </h2>
          <h2 className="orders-preview__headline orders-preview__order-day">
            Auftragsdatum
          </h2>
          ...
          {ordersStorageArray.map((order) => {
            return (
              <div className="orders-preview__order-info-div">
                <div className="orders-preview__order-info orders-preview__service-id center-content">
                  {order.id}
                </div>
                <div className="orders-preview__order-info orders-preview__service-day center-content">
                  {new Date(order.order_day).toLocaleString("de-DE", {
                    dateStyle: "medium",
                  })}
                </div>
                ...
                <div className="orders-preview__order-info orders-preview__options">
                  <div className="orders-preview__buttons center-content">
                    <div className="order-preview__action-order-tool-tip-div">
                      ...
                      <svg
                        ...
                        stroke-width="1.5"
                        stroke="currentColor"
                        className="orders-preview__detail-icon hover"
                      >
                        <path
                          stroke-linecap="round"
                          stroke-linejoin="round"
