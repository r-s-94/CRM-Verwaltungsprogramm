...
export default function EmployeesPreviewComponent({
  ...
  */
  ...
  return (
    <div className="employees-preview">
          ...
          <div className="employees-preview__popup-message-div">
            ...
            <div className="employees-preview__popup-message-div--button-div">
              <button
                ...
                className="employees-preview__popup-message-div--button-div--delete-button button"
              >
                <svg
              ...
              <button
                ...
                className="employees-preview__popup-message-div--button-div--close-button button"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
      ...
      <table className="employees-preview__table">
        ...
        {employeesStorageArray.map((employee) => {
          return (
            <tr className="employees-preview__table--tr">
              <td className="employees-preview__table--tr--td employees-preview__table--tr--td--employee-first-name ">
                {employee.Vorname}
              </td>
              <td className="employees-preview__table--tr--td employees-preview__table--tr--td--employee-last-name ">
                {employee.Nachname}
              </td>
              <td className="employees-preview__table--tr--td employees-preview__table--tr--td--employee-age ">
                {employee.Alter}
              </td>
              <td className="employees-preview__table--tr--td employees-preview__table--tr--td--employee-note ">
                {employee.Bemerkung}
              </td>
    ...
    /*  <div className="employees-preview__delete-employee-popup-main-window employee__popup-main-window">
          {" "}
          <div className="employees-preview__delete-employee-popup-main-window--delete-employee-popup-message-window employee__popup-main-window--popup-message-window">
