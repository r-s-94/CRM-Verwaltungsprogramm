      ...
      {newEmployeeForm && (
        <PopUp>
          <div className="new-employee__form">
            ...
            <div className="new-employee__label-and-inputs">
              <div className="new-employee__labels">
              ...
              <div className="new-employee__inputs">
                <div className="new-employee__input-infos">
                  <select
                    name=""
                    onChange={(event) => {
                      setEmployeeValueAdministration({
                  ...
                  >
                    ...
                    <option value="Divers" className="new-employee__option">
                      Divers
                    </option>
                ...
                <div className="new-employee__input-infos">
                  <div className="new-employee__street-street-number-collect">
                    <input
                      type="text"
                      name=""
            ...
            <div className="new-employee__buttons center-content">
              <button
                onClick={closeNewEmployeeForm}
