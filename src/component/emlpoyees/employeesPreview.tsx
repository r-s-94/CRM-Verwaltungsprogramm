  ...
  return (
    <div className="employees-preview">
      ...
      {deleteEmployeePopUp && (
        <PopUp>
          <div className="employees-preview__question">
            ...
            <div className="employees-preview__buttons center-content">
              <button
                onClick={closeDeleteEmployeePopUp}
      ...
      {singleEmployeePopUp && (
        <PopUp>
          <div className="employees-preview__single-employee">
            ...
            <div className="employees-preview__single-table center-content">
              <div className="employees-preview__single-headlines">
              ...
              <div className="employees-preview__single-infos">
                ...
                <div className="employees-preview__single-employee-info employees-preview__single-employee-birthday-info number">
                ...
                <div className="employees-preview__single-employee-info employees-preview__single-employee-age-info number">
                  {calculateEmployeeAge(currentEmployeeObject.age)}
                </div>
      ...
      <div className="employees-preview__table center-content-column">
        ...
        <div className="employees-preview__headlines center-content">
        ...
        <div className="employees-preview__employees-preview">
          {employeesStorageArray.map((employee) => {
            return (
              <div className="employees-preview__employee-infos">
                ...
                <div className="employees-preview__employee-info employees-preview__options center-content">
                  <button
                    onClick={() => {
                  ...
                  >
                    <div className="employees-preview__action-employee-tool-tips">
