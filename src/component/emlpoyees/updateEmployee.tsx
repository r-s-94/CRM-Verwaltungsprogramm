      ...
      {updateEmployeeForm && (
        <PopUpComponent>
          <div className="update-employee__form">
            ...
            <div className="update-employee__label-and-inputs">
              <div className="update-employee__labels">
                ...
                <label className="update-employee__label-PLZ label">PLZ:</label>
              ...
              <div className="update-employee__inputs">
                <div className="update-employee__input-infos">
                  <select
                    name=""
                    onChange={(event) => {
                      setEmployeeValueAdministration({
                  ...
                  >
                    ...
                    <option value="Divers" className="update-employee__option">
                      Divers
                    </option>
                ...
                <div className="update-employee__input-infos">
                  <div className="update-employee__street-street-number-collect">
                    <input
                      type="text"
                      name=""
            ...
            <div className="update-employee__buttons center-content">
              <button
                onClick={closeUpdateEmployeeForm}
