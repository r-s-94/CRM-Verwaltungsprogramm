      ...
      {updateClientForm && (
        <PopUp>
          <div className="update-client__form">
            ...
            <div className="update-client__label-and-inputs">
              <div className="update-client__labels">
              ...
              <div className="update-client__inputs">
                <div className="update-client__input-infos">
                  <select
                    name=""
                    onChange={(event) => {
                      setClientValueAdministration({
                  ...
                  >
                    ...
                    <option value="Divers" className="update-client__option">
                      Divers
                    </option>
                ...
                <div className="update-client__input-infos">
                  <div className="update-client__street-street-number-collect">
                    <input
                      type="text"
                      name=""
            ...
            <div className="update-client__buttons center-content">
              <button
                onClick={closeUpdateClientForm}
