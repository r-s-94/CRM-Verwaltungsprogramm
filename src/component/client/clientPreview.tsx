  ...
  return (
    <div className="clients-preview">
      {deleteClientPopUp && (
        <PopUp>
          <div className="clients-preview__question">
            ...
            <div className="clients-preview__dialog-buttons center-content">
              <button
                onClick={closeshowDeleteClientPopUp}
      ...
      {singleClientPopUp && (
        <PopUp>
          <div className="clients-preview__single-client ">
            ...
            <div className="clients-preview__single-table center-content">
              <div className="clients-preview__single-headlines">
              ...
              <div className="clients-preview__single-infos">
                ...
                <div className="clients-preview__single-client-info clients-preview__single-client-birthday-info number">
                ...
                <div className="clients-preview__single-client-info clients-preview__single-client-age-info number">
                  {calculateClientAge(currentClientObject.age)}
                </div>
      ...
      <div className="clients-preview__table center-content-column">
        ...
        <div className="clients-preview__headlines center-content">
        ...
        <div className="clients-preview__clients-preview">
          {clientsStorageArray.map((client) => {
            return (
              <div className="clients-preview__client-infos">
                ...
                <div className="clients-preview__client-info clients-preview__options center-content">
                  <button
                    onClick={() => {
                      setPopUpWidthHeightObject({
                        ...popUpWidthHeightObject,
